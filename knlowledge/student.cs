...
namespace knlowledge
{
    public partial class student : Form
    {
        ...
        {
            //First, we want to show the last student identification number, add one to it, and display it on the Visual Studio interface
            ...
            SqlCommand com1 = new SqlCommand("select max (student_id)+1 from student", coon);
            ...
            //Fill the combobox data adapter with a SQL server and write name of connection To fetch data for all students
            da = new SqlDataAdapter("select * from student", coon);
            ...
            textBox5.DataBindings.Add("text", dtt, "student_name");
            textBox6.DataBindings.Add("text", dtt, "student_address");
            textBox7.DataBindings.Add("text", dtt, "student_phone");
            coon.Close();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand com1 = new SqlCommand("INSERT INTO [student]([student_name],[student_address],[student_phone]) VALUES('"+textBox2.Text+"','"+textBox3.Text+"','"+textBox4.Text+"')", coon);

            //The implementation of the SQL Server code
            com1.ExecuteNonQuery();
            //show message when new student add
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            //Define the code to be executed from within the SQL server and show its result on the Visual Studio 
            //interface and write it within the SQL command Within a variable named dd1
            //Here is the code update student from the database
            ...
            //Code implementation
            dd1.ExecuteNonQuery();
            //show messege when student updated
